...
WebUI.click(findTestObject('Кадровый состав/Исполнительный аппарат Тюмень'))
...
WebUI.click(findTestObject('Кадровый состав/Северные электрические сети Тюмень'))
...
WebUI.click(findTestObject('Кадровый состав/Тюменские распределительные сети'))
