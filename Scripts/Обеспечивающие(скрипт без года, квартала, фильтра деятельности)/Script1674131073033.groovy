...
static def WriteToExcel() {
	...
	if(mass.length==1) {
		String mass1 = mass[0]
		String mass2 = 'Все филиалы'
		String mass3 = 'Все ДЗО'
		...
		String excelFilePath = 'C:\\Users\\shehs\\OneDrive\\Desktop\\HR\\Data Files\\HR.xlsx'
			...
			println(date)
				...
				if (date== 'Все') {
					String year = '2015-2021'
					String quarter = '1-4 квартал'
					...
					if (WebUI.verifyTextNotPresent('нет данных', false) == false) {
						...
						ExcelKeywords.setValueToCellByIndex(sheet01, n, 7, year)
			
						ExcelKeywords.setValueToCellByIndex(sheet01, n, 8, quarter)
