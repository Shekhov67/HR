...
WebUI.scrollToElement(findTestObject('Общие элементы/Развернуть Россети ФСК ЕЭС'), 30)

WebUI.click(findTestObject('Кадровый состав/Россети ФСК ЕЭС'))
...
WebUI.click(findTestObject('Общие элементы/Развернуть Россети ФСК ЕЭС'))

WebUI.click(findTestObject('Общие элементы/ИА ФСК ЕЭС'))
