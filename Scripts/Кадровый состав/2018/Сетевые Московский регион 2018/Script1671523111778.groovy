...
WebUI.click(findTestObject('Кадровый состав/Развернуть Московский регион'))

WebUI.click(findTestObject('Кадровый состав/Восточные электрические сети МСК'))
...
WebUI.click(findTestObject('Кадровый состав/Северные электрические сети МСК'))
...
WebUI.scrollToElement(findTestObject('Кадровый состав/Южные электрические сети МСК'), 30)

WebUI.click(findTestObject('Кадровый состав/Южные электрические сети МСК'))
