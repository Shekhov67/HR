...
WebUI.click(findTestObject('Кадровый состав/Обеспечивающие'))
...
WebUI.click(findTestObject('Кадровый состав/Развернуть Обеспечивающие'))
...
WebUI.click(findTestObject('Кадровый состав/НИЦ ЕЭС нижний уровень'))
...
WebUI.click(findTestObject('Кадровый состав/Центр технического заказчика'))
...
WebUI.click(findTestObject('Кадровый состав/Развернуть Центр технического заказчика'))

WebUI.click(findTestObject('Кадровый состав/Центр технического заказчика нижний уровень'))
...
WebUI.scrollToElement(findTestObject('Кадровый состав/ДЗО ПАО ФИЦ'), 30)
...
WebUI.click(findTestObject('Кадровый состав/Развернуть ПАО СЗЭУК'))

WebUI.click(findTestObject('Кадровый состав/ПАО СЗЭКУК нижний уровень'))
...
WebUI.scrollToElement(findTestObject('Кадровый состав/ПАО СЗЭУК'), 30)

WebUI.click(findTestObject('Кадровый состав/Управление ВОЛС-ВЛ'))
