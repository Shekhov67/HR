...
WebUI.click(findTestObject('Кадровый состав/Россети Кубань'))
...
WebUI.scrollToElement(findTestObject('Кадровый состав/Россети Кубань'), 30)

WebUI.click(findTestObject('Кадровый состав/Исполнительный аппарат Россети Кубань'))
...
WebUI.scrollToElement(findTestObject('Кадровый состав/Исполнительный аппарат Россети Кубань'), 30)
...
WebUI.click(findTestObject('Кадровый состав/Тихорецкие электрические сети'))
