...
WebUI.scrollToElement(findTestObject('Численность персонала/2021-3'), 30)
...
WebUI.click(findTestObject('Кадровый состав/Россети Центр'))
...
WebUI.click(findTestObject('Кадровый состав/Исполнительный аппарат Центр'))
...
WebUI.click(findTestObject('Кадровый состав/Ярэнерго'))
