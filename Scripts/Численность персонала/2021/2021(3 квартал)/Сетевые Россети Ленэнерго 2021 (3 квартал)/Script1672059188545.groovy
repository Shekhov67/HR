...
WebUI.click(findTestObject('Численность персонала/Исполнительный аппарат Ленэнерго'))
...
WebUI.click(findTestObject('Численность персонала/Ленинградская область'))
...
WebUI.click(findTestObject('Численность персонала/Санкт-Петербург'))
