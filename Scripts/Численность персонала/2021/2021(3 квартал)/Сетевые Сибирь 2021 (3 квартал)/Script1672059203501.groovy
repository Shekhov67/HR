...
WebUI.click(findTestObject('Кадровый состав/Россети Сибирь'))
...
WebUI.click(findTestObject('Кадровый состав/Исполнительный аппарат Сибирь'))
...
WebUI.scrollToElement(findTestObject('Кадровый состав/Исполнительный аппарат Сибирь'), 30)
