...
WebUI.click(findTestObject('Кадровый состав/Россети Северный Кавказ верхний уровень'))
...
WebUI.click(findTestObject('Кадровый состав/Исполнительный аппарат Северный Кавказ'))
...
WebUI.click(findTestObject('Кадровый состав/Севкавказэнерго Сетевые'))
