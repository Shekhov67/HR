...
WebUI.click(findTestObject('Кадровый состав/Россети Северо-Запад верхний уровень'))
...
WebUI.click(findTestObject('Кадровый состав/Исполнительный аппарат Северо-Запад'))
