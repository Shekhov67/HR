...
WebUI.click(findTestObject('Кадровый состав/Сетевые'))
...
WebUI.click(findTestObject('Кадровый состав/Тываэнерго верхний уровень'))
...
WebUI.click(findTestObject('Общие элементы/Развернуть Тываэнерго'))

WebUI.click(findTestObject('Кадровый состав/Тываэнерго нижний уровень'))
...
WebUI.click(findTestObject('Кадровый состав/Чеченэнерго верхний уровень'))
...
WebUI.click(findTestObject('Кадровый состав/Чеченэнерго нижний уровень'))
