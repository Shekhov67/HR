...
WebUI.scrollToElement(findTestObject('Кадровый состав/Развернуть Московский регион'), 30)

WebUI.scrollToElement(findTestObject('Численность персонала/a_DZO'), 30)

WebUI.click(findTestObject('Кадровый состав/Россети Московский регион'))
...
WebUI.click(findTestObject('Численность персонала/Развернуть Московский регион'))

WebUI.click(findTestObject('Кадровый состав/Исполнительный аппарат Московский регион'))
...
WebUI.click(findTestObject('Численность персонала/Мосовская область'))
...
WebUI.click(findTestObject('Численность персонала/Москва'))
...
//percentCheck = Percents()
WebUI.closeBrowser( //Необходимо указать корректный путь до файла c Test Data
