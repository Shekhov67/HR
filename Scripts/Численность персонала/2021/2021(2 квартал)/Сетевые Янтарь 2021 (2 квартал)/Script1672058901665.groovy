...
WebUI.click(findTestObject('Кадровый состав/Россети Янтарь'))
...
WebUI.click(findTestObject('Кадровый состав/Восточные электрические сети Янтарь'))
...
WebUI.click(findTestObject('Кадровый состав/Западные электрические сети Янтарь'))
...
WebUI.click(findTestObject('Кадровый состав/Исполнительный аппарат Янтарь'))
