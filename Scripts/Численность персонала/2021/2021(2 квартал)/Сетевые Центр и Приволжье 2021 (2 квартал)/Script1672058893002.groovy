...
WebUI.click(findTestObject('Кадровый состав/Россети Центр и Приволжье'))
...
WebUI.click(findTestObject('Кадровый состав/Исполнительный аппарат Центр и Приволжье'))
