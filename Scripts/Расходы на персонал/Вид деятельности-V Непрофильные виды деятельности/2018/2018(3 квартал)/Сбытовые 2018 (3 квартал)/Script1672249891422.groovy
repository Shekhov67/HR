...
WebUI.click(findTestObject('Расходы на персонал/div-2018'))

WebUI.scrollToElement(findTestObject('Расходы на персонал/2018-3'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/2018-3'))
