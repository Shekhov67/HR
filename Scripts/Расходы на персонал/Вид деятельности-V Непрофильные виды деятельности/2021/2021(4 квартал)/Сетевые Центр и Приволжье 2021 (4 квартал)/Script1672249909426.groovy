...
WebUI.scrollToElement(findTestObject('Общие элементы/Развернуть Россети Центр и Приволжье'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/Россети Центр и Приволжье'))
...
WebUI.click(findTestObject('Общие элементы/Развернуть Россети Центр и Приволжье'))

WebUI.click(findTestObject('Общие элементы/Владимирэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Ивэнерго'))
...
WebUI.click(findTestObject('Расходы на персонал/Исполнительный аппарат Центр и Приволжье'))
...
WebUI.click(findTestObject('Общие элементы/Калугаэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Кировэнерго'))
...
WebUI.scrollToElement(findTestObject('Общие элементы/Кировэнерго'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Общие элементы/Мариэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Нижновэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Рязаньэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Тулэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Удмуртэнерго'))
