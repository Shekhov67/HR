...
WebUI.scrollToElement(findTestObject('Общие элементы/Развернуть Россети Урал'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/Россети Урал'))
...
WebUI.click(findTestObject('Общие элементы/Развернуть Россети Урал'))

WebUI.click(findTestObject('Расходы на персонал/Исполнительный аппарат Россети Урал'))
...
WebUI.click(findTestObject('Общие элементы/Пермэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Свердловэнерго'))
...
WebUI.scrollToElement(findTestObject('Расходы на персонал/Челябэнерго'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/Челябэнерго'))
