...
WebUI.scrollToElement(findTestObject('Общие элементы/Развернуть Россети Янтарь'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/Россети Янтарь'))
...
WebUI.click(findTestObject('Общие элементы/Развернуть Россети Янтарь'))

WebUI.scrollToElement(findTestObject('Расходы на персонал/АО Янтарьэнергосбыт'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/АО Янтарьэнергосбыт'))
...
WebUI.click(findTestObject('Расходы на персонал/Восточные электрические сети Янтарь'))
...
WebUI.click(findTestObject('Общие элементы/Городские электрические сети'))
...
WebUI.click(findTestObject('Расходы на персонал/Западные электрические сети Янтарь'))
...
WebUI.click(findTestObject('Расходы на персонал/Исполнительный аппарат Янтарь'))
...
WebUI.scrollToElement(findTestObject('Общие элементы/Энергоремонт'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Общие элементы/Энергоремонт'))
