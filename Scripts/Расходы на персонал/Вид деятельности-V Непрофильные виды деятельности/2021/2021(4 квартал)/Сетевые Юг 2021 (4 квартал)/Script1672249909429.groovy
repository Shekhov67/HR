...
WebUI.click(findTestObject('Расходы на персонал/Россети Юг'))
...
WebUI.click(findTestObject('Расходы на персонал/Исполнительный аппарат Юг'))
...
WebUI.click(findTestObject('Расходы на персонал/Кубаньэнерго Юг'))
...
WebUI.scrollToElement(findTestObject('Расходы на персонал/Кубаньэнерго Юг'), 30)
