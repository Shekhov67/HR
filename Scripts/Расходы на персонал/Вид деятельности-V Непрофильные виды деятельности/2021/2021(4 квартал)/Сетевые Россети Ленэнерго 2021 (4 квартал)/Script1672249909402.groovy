...
WebUI.scrollToElement(findTestObject('Расходы на персонал/Россети Ленэнерго'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/Россети Ленэнерго'))
...
WebUI.click(findTestObject('Расходы на персонал/Развернуть Россети Ленэнерго'))

WebUI.click(findTestObject('Общие элементы/Выборгские электрические сети'))
...
WebUI.click(findTestObject('Общие элементы/Гатчинские электрические сети'))
...
WebUI.click(findTestObject('Общие элементы/Дирекция строящихся объектов'))
...
WebUI.click(findTestObject('Расходы на персонал/Исполнительный аппарат Россети Ленэнерго'))
...
WebUI.scrollToElement(findTestObject('Общие элементы/Дирекция строящихся объектов'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Общие элементы/Кабельная сеть Россети Ленэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Кингисеппские электрические сети'))
...
WebUI.click(findTestObject('Общие элементы/Лужские ЭС'))
...
WebUI.scrollToElement(findTestObject('Общие элементы/Кингисеппские электрические сети'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Общие элементы/Новоладожские электрические сети'))
...
WebUI.click(findTestObject('Общие элементы/Санкт-Петербургские высоковольтные электрические сети'))
...
WebUI.scrollToElement(findTestObject('Общие элементы/Санкт-Петербургские высоковольтные электрические сети'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/Северные электрические сети Ленэнерго'))
...
WebUI.click(findTestObject('Расходы на персонал/Тихвинские электрические сети'))
...
WebUI.click(findTestObject('Расходы на персонал/Южные электрические сети Ленэнерго'))
