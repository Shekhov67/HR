...
WebUI.scrollToElement(findTestObject('Общие элементы/Развернуть Россети Центр'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/Россети Центр'))
...
WebUI.click(findTestObject('Общие элементы/Развернуть Россети Центр'))

WebUI.click(findTestObject('Общие элементы/Белгородэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Брянскэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Воронежэнерго'))
...
WebUI.click(findTestObject('Расходы на персонал/Исполнительный аппарат Центр'))
...
WebUI.click(findTestObject('Общие элементы/Костромаэнерго'))
...
WebUI.scrollToElement(findTestObject('Общие элементы/Костромаэнерго'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Общие элементы/Курскэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Липецкэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Орелэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Смоленскэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Тамбовэнерго'))
...
WebUI.scrollToElement(findTestObject('Общие элементы/Тамбовэнерго'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Общие элементы/Тверьэнерго'))
...
WebUI.click(findTestObject('Расходы на персонал/Ярэнерго'))
