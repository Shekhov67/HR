...
WebUI.scrollToElement(findTestObject('Общие элементы/Развернуть Россети Северный Кавказ'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/Россети Северный Кавказ верхний уровень'))
...
WebUI.click(findTestObject('Общие элементы/Развернуть Россети Северный Кавказ'))

WebUI.click(findTestObject('Расходы на персонал/АО Калмэнергосбыт'))
...
WebUI.click(findTestObject('Расходы на персонал/Дагестанская энергосбытовая компания'))
...
WebUI.click(findTestObject('Общие элементы/Дагэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Ингушэнерго'))
...
WebUI.click(findTestObject('Расходы на персонал/Исполнительный аппарат Северный Кавказ'))
...
WebUI.scrollToElement(findTestObject('Общие элементы/Каббалкэнерго'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Общие элементы/Каббалкэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Карачаево-Черкесскэнерго'))
...
WebUI.click(findTestObject('Расходы на персонал/Севкавказэнерго Сетевые'))
...
WebUI.scrollToElement(findTestObject('Общие элементы/Ставропольэнерго'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Общие элементы/Ставропольэнерго'))
