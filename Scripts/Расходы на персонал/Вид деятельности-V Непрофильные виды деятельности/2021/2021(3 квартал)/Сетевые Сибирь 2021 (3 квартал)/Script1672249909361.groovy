...
WebUI.scrollToElement(findTestObject('Общие элементы/Развернуть Россети Сибирь'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/Россети Сибирь'))
...
WebUI.click(findTestObject('Общие элементы/Развернуть Россети Сибирь'))

WebUI.click(findTestObject('Общие элементы/Алтайэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Бурятэнерго'))
...
WebUI.click(findTestObject('Общие элементы/ГАЭС'))
...
WebUI.click(findTestObject('Расходы на персонал/Исполнительный аппарат Сибирь'))
...
WebUI.scrollToElement(findTestObject('Расходы на персонал/Исполнительный аппарат Сибирь'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Общие элементы/Красноярскэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Кузбассэнерго-РЭС'))
...
WebUI.click(findTestObject('Общие элементы/Омскэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Хакасэнерго'))
...
WebUI.click(findTestObject('Общие элементы/Читаэнерго'))
