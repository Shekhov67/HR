...
WebUI.scrollToElement(findTestObject('Расходы на персонал/Россети ФСК ЕЭС1'), 30)

WebUI.scrollToElement(findTestObject('Расходы на персонал/a_DZO'), 30)

WebUI.click(findTestObject('Расходы на персонал/выбрать Россети ФСК ЕЭС'))
...
WebUI.click(findTestObject('Расходы на персонал/Россети ФСК ЕЭС1'))

WebUI.click(findTestObject('Расходы на персонал/ИА ФСК ЕЭС'))
